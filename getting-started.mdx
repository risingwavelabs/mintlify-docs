...
- **Node.js** >= 20
- **RisingWave** — Wavelet will start it automatically in dev mode if you have it [installed](https://docs.risingwave.com/deploy/risingwave-docker-compose), or you can use Docker
...
- [TypeScript SDK](/sdk/client) — client API details
- [React hooks](/sdk/react) — `useWavelet` in depth
- [JWT multi-tenant filtering](/server/jwt-auth) — per-user data isolation
- [Postgres CDC sources](/sources/postgres-cdc) — ingest from existing databases
- [MCP for AI agents](/mcp) — let agents query and write data
