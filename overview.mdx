...
Wavelet is a real-time backend that sits on top of [RisingWave](https://docs.risingwave.com/get-started/intro). You define SQL views in a config file, and Wavelet turns them into live APIs that push diffs to your frontend over WebSocket.
