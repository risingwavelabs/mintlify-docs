...
| Status | Body | When |
|--------|------|------|
| `404` | `{ "error": "View 'foo' not found.", "available_views": ["leaderboard"] }` | View does not exist |
...
| Status | Body | When |
|--------|------|------|
| `404` | `{ "error": "Stream 'foo' not found.", "available_streams": ["game_events"] }` | Stream does not exist |
